...
class TestReviewsIntegration:
    def test_create_self_review(self, client, auth_headers, test_goal_data):
        ...
        # Создаем цель
        goal_response = client.post("/api/v1/goals/", json=test_goal_data, headers=auth_headers)
    ...
    def test_unauthorized_respondent_review(self, client, auth_headers, test_goal_data):
        ...
        response = client.post("/api/v1/reviews/respondent", json=review_data, headers=auth_headers)
