...
def init_default_questions():
    ...
    try:
        ...
        existing_count = db.query(QuestionTemplate).filter(QuestionTemplate.is_active == True).count()
        if existing_count > 0:
        ...
        self_evaluation_questions = [
            {
                ...
                "max_score": 10,
                "order_index": 1,
                "trigger_words": json.dumps(["достижен", "результат", "успех", "рост", "улучшен", "оптимизац"]),
                "options_json": None,
            ...
            },
            {
                ...
                "max_score": 10,
                "order_index": 2,
                "trigger_words": json.dumps(["вклад", "личный", "инициатив", "ответствен"]),
                "options_json": None,
                "requires_manager_scoring": True
            },
            {
            ...
            },
            {
                ...
                "max_score": 10,
                "order_index": 5,
                "trigger_words": json.dumps(["коммуникац", "взаимодейств", "общен", "команд"]),
                "options_json": None,
            ...
            },
            {
                ...
                "max_score": 10,
                "order_index": 6,
                "trigger_words": json.dumps(["удовлетворен", "оценка", "результат", "выполнен"]),
                "options_json": None,
                "requires_manager_scoring": False
            }
        ]
        ...
        manager_evaluation_questions = [
            ...
            },
            {
                ...
                "order_index": 2,
                "trigger_words": json.dumps(["качества", "личные", "ответствен", "инициатив"]),
                "options_json": None,
                "requires_manager_scoring": True
            },
            {
                ...
                "max_score": 10,  # Текстовая оценка - балл не нужен
                "order_index": 3,
                "trigger_words": json.dumps(["вклад", "результат", "влияние", "ценность"]),
                "options_json": None,
                "requires_manager_scoring": True
            },
            {
                ...
                "max_score": 10,
                "order_index": 4,
                "trigger_words": json.dumps(["коммуникац", "взаимодейств", "команд", "общен"]),
                "options_json": None,
                "requires_manager_scoring": False
            },
            {
                ...
                "max_score": 10,  # Текстовая оценка - балл не нужен
                "order_index": 5,
                "trigger_words": json.dumps(["улучшен", "рекомендац", "развит", "рост"]),
                "options_json": None,
                "requires_manager_scoring": True
            },
            {
        ...
        potential_evaluation_questions = [
            # Профессиональные качества
            {
                ...
                "max_score": 5,
                "order_index": 1,
                "trigger_words": json.dumps(["профессионал", "качества", "навыки", "компетенц"]),
            ...
            
            {
                ...
                "max_score": 1,
                "order_index": 3,
                "trigger_words": json.dumps(["мотивац", "1:1", "дополнительн", "руководств"]),
                "options_json": None,
                "requires_manager_scoring": False
            },
            {
                ...
                "max_score": 1,
                "order_index": 4,
                "trigger_words": json.dumps(["информац", "проблем", "негатив", "результат"]),
                "options_json": None,
                "requires_manager_scoring": False
            },
            {
        ...
        logger.info("- Оценка руководителя: %d вопросов", len(manager_evaluation_questions))
        logger.info("- Оценка потенциала: %d вопросов", len(potential_evaluation_questions))
        logger.info("- Оценка респондентов: %d вопросов", len(respondent_evaluation_questions))
